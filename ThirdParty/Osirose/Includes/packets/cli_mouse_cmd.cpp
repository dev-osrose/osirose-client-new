...
CliMouseCmd& CliMouseCmd::set_targetId(const uint16_t targetId) {
...
CliMouseCmd& CliMouseCmd::set_x(const float x) {
    this->x = x;
    return *this;
}
...
CliMouseCmd& CliMouseCmd::set_y(const float y) {
    this->y = y;
    return *this;
}
...
CliMouseCmd& CliMouseCmd::set_z(const uint16_t z) {
    this->z = z;
    return *this;
}
