...
class SrvBankMoveItem : public CRosePacket {
    public:
        static constexpr ePacketType PACKET_ID = ePacketType::PAKWC_BANK_MOVE_ITEM;
        SrvBankMoveItem();
        SrvBankMoveItem(CRoseReader reader);
        SrvBankMoveItem(SrvBankMoveItem&&) = default;
        SrvBankMoveItem& operator=(SrvBankMoveItem&&) = default;
        ~SrvBankMoveItem() = default;
        ...
        SrvBankMoveItem& set_inventory_index(const int16_t);
        int16_t get_inventory_index() const;
        SrvBankMoveItem& set_bank_index(const int16_t);
        int16_t get_bank_index() const;
        SrvBankMoveItem& set_inventory_item(const Item);
        Item get_inventory_item() const;
        SrvBankMoveItem& set_bank_item(const Item);
        Item get_bank_item() const;
        SrvBankMoveItem& set_money(const int64_t);
        int64_t get_money() const;
        
        
        static SrvBankMoveItem create(const int16_t& inventory_index, const int16_t& bank_index, const Item& inventory_item, const Item& bank_item, const int64_t& money);
        static SrvBankMoveItem create(const uint8_t* buffer);
        static std::unique_ptr<SrvBankMoveItem> allocate(const uint8_t* buffer);
