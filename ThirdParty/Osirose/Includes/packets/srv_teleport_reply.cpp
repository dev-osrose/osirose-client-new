...
SrvTeleportReply& SrvTeleportReply::set_id(const uint16_t id) {
    this->id = id;
    return *this;
}
...
SrvTeleportReply& SrvTeleportReply::set_map(const uint16_t map) {
    this->map = map;
    return *this;
}
...
SrvTeleportReply& SrvTeleportReply::set_x(const float x) {
    this->x = x;
    return *this;
}
...
SrvTeleportReply& SrvTeleportReply::set_y(const float y) {
    this->y = y;
    return *this;
}
...
SrvTeleportReply& SrvTeleportReply::set_moveMode(const uint8_t moveMode) {
...
SrvTeleportReply& SrvTeleportReply::set_rideMode(const uint8_t rideMode) {
